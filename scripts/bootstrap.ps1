...
# TODO MacOS/Linux: New-Item -Path "~/.config/powershell/Microsoft.PowerShell_profile.ps1 -ItemType SymbolicLink -Value "$env:USERPROFILE\.dotfiles\config\powershell\Microsoft.PowerShell_profile.ps1"
